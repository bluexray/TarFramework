...
namespace TarFramework.T_araNet
{
    public class BufferReadStream:Stream
    {
                ...
                if (value != this._capacity)
                {
                    ...
                    else
                    {
                        if (value > 0)
                        {
                            ...
                            if (this._length > 0)
                            {
                               System.Buffer.BlockCopy(Datas, 0, dst, 0, this._length);
                            }
                            this.Datas = dst;
                        }
                        else
        ...
        public BufferReadStream(): this(0, 4096, 4)
        {

        }


        public BufferReadStream(int maxSize):this(0,maxSize,4)
        {
          
        }

        public BufferReadStream(int maxSize, int headBit) : this(0, maxSize, headBit)
        {

        }

        public BufferReadStream(int capacity, int maxSize,int headBit)
        {
            MaxSize = maxSize;
            _capacity = capacity;
        ...
        public virtual bool Read(out byte[] data)
        {
            ...
            if ((_pw+_headlengt) <= _position)
            {
                ...
                System.Buffer.BlockCopy(Datas, _pw, data, 0, data.Length);                              
